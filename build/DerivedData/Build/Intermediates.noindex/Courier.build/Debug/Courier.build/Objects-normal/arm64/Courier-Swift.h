...
#ifndef COURIER_SWIFT_H
#define COURIER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Courier",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Courier11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC7Courier15CourierTextView")
@interface CourierTextView : NSTextView
...
SWIFT_CLASS("_TtC7Courier13LauncherPanel")
...
SWIFT_CLASS("_TtC7Courier24LauncherWindowController")
@interface LauncherWindowController : NSObject <NSWindowDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)windowDidResignKey:(NSNotification * _Nonnull)notification;
@end

SWIFT_CLASS("_TtC7Courier24SettingsWindowController")
...
@class NSWindow;
SWIFT_CLASS("_TtC7Courier27SetupWizardWindowController")
@interface SetupWizardWindowController : NSObject <NSWindowDelegate>
...
SWIFT_CLASS("_TtC7Courier10ToastPanel")
@interface ToastPanel : NSPanel
@property (nonatomic, readonly) BOOL canBecomeKeyWindow;
@property (nonatomic, readonly) BOOL canBecomeMainWindow;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)dismiss;
